...
RUN pip3 install pandas==0.23.0 numpy==1.14.3 scikit-learn==0.19.1 tqdm==4.26.0 seaborn==0.8.1 matplotlib==2.2.2 scipy==1.3.1 catboost==0.13.1 torch==1.2.0 torchvision==0.4.1 
